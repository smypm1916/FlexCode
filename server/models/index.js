...
const { sequelize } = require("../config/sequelize"); // sequelize 인스턴스

const Cart_info = require("./Cart_info")(sequelize, DataTypes);
const Community_info = require("./Community_info")(sequelize, DataTypes);
const Order_info = require("./Order_info")(sequelize, DataTypes);
const Order_items = require("./Order_items")(sequelize, DataTypes);
const Product_info = require("./Product_info")(sequelize, DataTypes);
const Product_option = require("./Product_option")(sequelize, DataTypes);
const User_account = require("./User_account")(sequelize, DataTypes);
